	...
	class Invoicing extends CI_Controller{
		...
		public function update_invoice(){
			...
			// Images Table
				...
				if ($result_invoice_update && $result_note_add && $result_invoice_rows_update && $result_image){
					...
					if ($result_invoice_update ) $result_invoice_update  = "OK";
					if ($result_invoice_rows_update ) $result_invoice_rows_update  = "OK";
					if ($result_note_add ) $result_note_add  = "OK";
					if ($result_image ) $result_image  = "OK";
		...
		public function save_invoice(){
...

			{
					...
					else if (!$override_flag && $result_invoice_add){

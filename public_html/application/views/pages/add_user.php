                ...
                <section class="widget">
                    ...
                    <div class="body">
                       <?php echo validation_errors('<span class="label label-important">'); ?></span>
                        ...
                        <form id="user-form" class="form-horizontal" novalidate method="post" data-parsley-priority-enabled="false" data-parsley-excluded="" action="<?php echo site_url(); ?>/users/add_user">
                            <fieldset>
                               <legend class="section">Username & Password</legend>
                                <div class="form-group">
                                    <label class="control-label col-sm-4 input-lg" for="user-name">User Name <span class="required">*</span>Username must not contain whitespaces</label>

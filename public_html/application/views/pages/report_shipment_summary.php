            ...
            <?php //endif; ?>
                   ...
                   <h1>Forecast</h1>
                       <table id="datatable-table" class="table table-striped table-hover dataTable no-footer" role="grid" aria-describedby="datatable-table_info">
                        ...
                        <tr role="row" class="odd">
                                    ...
                                    <td class=""><?php $sell_gst_sum = round($sell_sum/11, 2);
                                    echo $sell_gst_sum; ?></td>
                ...
                <?php //endif; ?>
                            ...
                            <tr>
                                ...
                                <td><!-- P/L inc GST -->
                                    $<?php $pl_inc_gst = $revenue - ($expense + $buy_sum);
                                    echo $pl_inc_gst;  ?>
                                </td>
                        ...
                        ?>
                                ...
                                <input type="text" name="actual_profit" id="actual_profit" value="<?php if (isset($_GET['profit'])) {
                                    echo $_GET['profit'];
                                                                                                  } ?>" class="form-control input-lg" style="" />
                                <?php if (isset($_GET['action'])) : ?>

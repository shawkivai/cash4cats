          ...
          <div class="row" onClick="pageload()">
            ...
            <div class="col-lg-12">
                ...
                <section class="widget">
                  ...
                  <h4 style="text-align: left;margin-top: 5px">INVOICE TOTAL: </h4>
                                <div class="input-group" style="margin-top:10px">
                                            <span class="input-group-addon">$</span><input type="text" id="total" name="total"  class="form-control" readonly></div>                                </div>
                                </div>
                            </fieldset>
                  </div>
                </section>
